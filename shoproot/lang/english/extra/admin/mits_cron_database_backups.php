...
$lang_array = array(
  ...
  'TEXT_INFO_TASKS_MITS_CRON_DATABASE_BACKUPS' => 'The database backup is started through the existing callback URL. Connection, HTTP and runtime errors are written to the MITS log when logging is enabled.',
  'BOX_MITS_CRON_DATABASE_RESTORE' => 'MITS Database Management',
  'BOX_MITS_CRON_DATABASE_TOOLS' => 'MITS Database Maintenance',
);
