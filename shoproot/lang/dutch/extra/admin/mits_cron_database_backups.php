...
$lang_array = array(
  ...
  'TEXT_INFO_TASKS_MITS_CRON_DATABASE_BACKUPS' => 'De databaseback-up wordt via de bestaande callback-URL gestart. Verbindings-, HTTP- en runtimefouten worden bij ingeschakelde logging in het MITS-log vastgelegd.',
  'BOX_MITS_CRON_DATABASE_RESTORE' => 'MITS-databasebeheer',
  'BOX_MITS_CRON_DATABASE_TOOLS' => 'MITS-databaseonderhoud',
);
