...
$lang_array = array(
  ...
  'TEXT_INFO_TASKS_MITS_CRON_DATABASE_BACKUPS' => 'Il backup del database viene avviato tramite l&rsquo;URL di callback esistente. Gli errori di connessione, HTTP e di esecuzione vengono registrati nel log MITS quando la registrazione &egrave; attiva.',
  'BOX_MITS_CRON_DATABASE_RESTORE' => 'Gestione database MITS',
  'BOX_MITS_CRON_DATABASE_TOOLS' => 'Manutenzione database MITS',
);
