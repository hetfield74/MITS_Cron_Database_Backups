...
$lang_array = array(
  ...
  'TEXT_INFO_TASKS_MITS_CRON_DATABASE_BACKUPS' => 'La copia de seguridad de la base de datos se inicia mediante la URL de callback existente. Los errores de conexi&oacute;n, HTTP y ejecuci&oacute;n se registran en el log MITS cuando el registro est&aacute; activado.',
  'BOX_MITS_CRON_DATABASE_RESTORE' => 'Gesti&oacute;n de base de datos MITS',
  'BOX_MITS_CRON_DATABASE_TOOLS' => 'Mantenimiento de base de datos MITS',
);
