...
defined('TEXT_MITS_CDB_RESTORE_RESULT_SUBTITLE') or define('TEXT_MITS_CDB_RESTORE_RESULT_SUBTITLE', 'Das Ergebnis der R&uuml;cksicherung wird unten angezeigt.');
...
defined('TEXT_MITS_CDB_SQL_RESULT_SUBTITLE') or define('TEXT_MITS_CDB_SQL_RESULT_SUBTITLE', 'Das Ergebnis der SQL-Ausf&uuml;hrung wird unten angezeigt.');
...
defined('TEXT_MITS_CDB_RESTORE_DELETE_RESULT_SUBTITLE') or define('TEXT_MITS_CDB_RESTORE_DELETE_RESULT_SUBTITLE', 'Das Ergebnis der L&ouml;schaktion wird unten angezeigt.');
...
defined('TEXT_MITS_CDB_CONVERT_TITLE') or define('TEXT_MITS_CDB_CONVERT_TITLE', 'Datenbank-Konvertierung');
defined('TEXT_MITS_CDB_CONVERT_SUBTITLE') or define('TEXT_MITS_CDB_CONVERT_SUBTITLE', 'Tabellen-Engine und Zeichensatz / Collation umstellen.');
defined('TEXT_MITS_CDB_CONVERT_WARNING_TITLE') or define('TEXT_MITS_CDB_CONVERT_WARNING_TITLE', 'Expertenfunktion');
defined('TEXT_MITS_CDB_CONVERT_WARNING') or define('TEXT_MITS_CDB_CONVERT_WARNING', 'Engine- und Zeichensatz-Konvertierungen &auml;ndern die aktuelle Shopdatenbank direkt. Vor der Konvertierung ausgew&auml;hlter Tabellen wird automatisch ein Sicherheitsbackup erstellt.');
defined('TEXT_MITS_CDB_CONVERT_SEPARATE_TITLE') or define('TEXT_MITS_CDB_CONVERT_SEPARATE_TITLE', 'Engine und Zeichensatz getrennt ausf&uuml;hren');
defined('TEXT_MITS_CDB_CONVERT_SEPARATE_INFO') or define('TEXT_MITS_CDB_CONVERT_SEPARATE_INFO', 'Tabellen-Engine und Zeichensatz sind technisch getrennte Eigenschaften. F&uuml;r moderne Shops ist InnoDB mit utf8mb4 meistens die empfohlene Kombination, utf8mb4 ist aber nicht zwingend an InnoDB gebunden.');
defined('TEXT_MITS_CDB_CONVERT_TARGET_ENGINE') or define('TEXT_MITS_CDB_CONVERT_TARGET_ENGINE', 'Ziel-Engine');
defined('TEXT_MITS_CDB_CONVERT_CONFIG_FILE') or define('TEXT_MITS_CDB_CONVERT_CONFIG_FILE', 'Aktive configure.php');
defined('TEXT_MITS_CDB_CONVERT_CONFIG_CURRENT_ENGINE') or define('TEXT_MITS_CDB_CONVERT_CONFIG_CURRENT_ENGINE', 'Aktueller DB_SERVER_ENGINE');
defined('TEXT_MITS_CDB_CONVERT_CONFIG_NOT_SET') or define('TEXT_MITS_CDB_CONVERT_CONFIG_NOT_SET', 'nicht gesetzt');
defined('TEXT_MITS_CDB_CONVERT_UPDATE_CONFIG') or define('TEXT_MITS_CDB_CONVERT_UPDATE_CONFIG', 'DB_SERVER_ENGINE in der aktiven configure.php auf die Ziel-Engine setzen.');
defined('TEXT_MITS_CDB_CONVERT_CONFIG_NOT_WRITABLE') or define('TEXT_MITS_CDB_CONVERT_CONFIG_NOT_WRITABLE', 'Die aktive configure.php ist aktuell nicht beschreibbar. Die Dateirechte werden beim Speichern automatisch kurzzeitig angepasst und anschlie&szlig;end wiederhergestellt.');
defined('TEXT_MITS_CDB_CONVERT_NO_TABLES') or define('TEXT_MITS_CDB_CONVERT_NO_TABLES', 'Es wurden keine MyISAM-/InnoDB-Tabellen gefunden.');
defined('TEXT_MITS_CDB_CONVERT_TABLES_INFO') or define('TEXT_MITS_CDB_CONVERT_TABLES_INFO', 'W&auml;hlen Sie die Tabellen aus, die auf die Ziel-Engine umgestellt werden sollen. Tabellen, die bereits die Ziel-Engine verwenden, werden &uuml;bersprungen.');
defined('TEXT_MITS_CDB_CONVERT_TABLES_SELECT_ALL') or define('TEXT_MITS_CDB_CONVERT_TABLES_SELECT_ALL', 'Alle Tabellen ausw&auml;hlen / abw&auml;hlen');
defined('TEXT_MITS_CDB_CONVERT_CONFIRM_CHECKBOX') or define('TEXT_MITS_CDB_CONVERT_CONFIRM_CHECKBOX', 'Ich habe die Auswahl gepr&uuml;ft und m&ouml;chte die Konvertierung starten.');
defined('TEXT_MITS_CDB_CONVERT_START') or define('TEXT_MITS_CDB_CONVERT_START', 'Konvertierung starten');
defined('TEXT_MITS_CDB_CONVERT_CONFIRM_JS') or define('TEXT_MITS_CDB_CONVERT_CONFIRM_JS', 'Datenbank-Konvertierung wirklich starten?\n\nBitte vorher pr&uuml;fen, ob ein aktuelles Backup vorhanden ist.');
defined('TEXT_MITS_CDB_CONVERT_RESULT_SUCCESS') or define('TEXT_MITS_CDB_CONVERT_RESULT_SUCCESS', 'Datenbank-Konvertierung abgeschlossen');
defined('TEXT_MITS_CDB_CONVERT_RESULT_ERROR') or define('TEXT_MITS_CDB_CONVERT_RESULT_ERROR', 'Datenbank-Konvertierung fehlgeschlagen');
defined('TEXT_MITS_CDB_CONVERT_RESULT_SUBTITLE') or define('TEXT_MITS_CDB_CONVERT_RESULT_SUBTITLE', 'Das Ergebnis der Datenbank-Konvertierung wird unten angezeigt.');
defined('TEXT_MITS_CDB_CONVERT_ERROR_CONFIRM') or define('TEXT_MITS_CDB_CONVERT_ERROR_CONFIRM', 'Die Best&auml;tigung f&uuml;r die Datenbank-Konvertierung fehlt.');
defined('TEXT_MITS_CDB_CONVERT_ERROR_NO_ACTION') or define('TEXT_MITS_CDB_CONVERT_ERROR_NO_ACTION', 'Es wurden keine Tabellen ausgew&auml;hlt und keine configure.php-Anpassung aktiviert.');
defined('TEXT_MITS_CDB_CONVERT_TABLE_INVALID') or define('TEXT_MITS_CDB_CONVERT_TABLE_INVALID', 'Tabelle wurde nicht gefunden oder wird nicht unterst&uuml;tzt: %s');
defined('TEXT_MITS_CDB_CONVERT_TABLE_SKIPPED') or define('TEXT_MITS_CDB_CONVERT_TABLE_SKIPPED', 'Tabelle %s ist bereits %s.');
defined('TEXT_MITS_CDB_CONVERT_TABLE_SUCCESS') or define('TEXT_MITS_CDB_CONVERT_TABLE_SUCCESS', 'Tabelle %s wurde auf %s konvertiert.');
defined('TEXT_MITS_CDB_CONVERT_TABLE_ERROR') or define('TEXT_MITS_CDB_CONVERT_TABLE_ERROR', 'Tabelle %s konnte nicht konvertiert werden: %s');
defined('TEXT_MITS_CDB_CONVERT_SUMMARY') or define('TEXT_MITS_CDB_CONVERT_SUMMARY', 'Konvertierung abgeschlossen: %s konvertiert, %s &uuml;bersprungen, %s fehlgeschlagen.');
defined('TEXT_MITS_CDB_CONVERT_CONFIG_ERROR_READ') or define('TEXT_MITS_CDB_CONVERT_CONFIG_ERROR_READ', 'Die aktive configure.php konnte nicht gelesen werden.');
defined('TEXT_MITS_CDB_CONVERT_CONFIG_ERROR_WRITE') or define('TEXT_MITS_CDB_CONVERT_CONFIG_ERROR_WRITE', 'Die aktive configure.php konnte nicht beschreibbar gesetzt werden: %s');
defined('TEXT_MITS_CDB_CONVERT_CONFIG_ERROR_BACKUP') or define('TEXT_MITS_CDB_CONVERT_CONFIG_ERROR_BACKUP', 'Die Sicherung der configure.php konnte nicht erstellt werden: %s');
defined('TEXT_MITS_CDB_CONVERT_CONFIG_ERROR_SAVE') or define('TEXT_MITS_CDB_CONVERT_CONFIG_ERROR_SAVE', 'Die configure.php konnte nicht gespeichert werden.');
defined('TEXT_MITS_CDB_CONVERT_CONFIG_BACKUP_CREATED') or define('TEXT_MITS_CDB_CONVERT_CONFIG_BACKUP_CREATED', 'Sicherung der configure.php erstellt: %s');
defined('TEXT_MITS_CDB_CONVERT_CONFIG_PERMISSIONS_RESTORED') or define('TEXT_MITS_CDB_CONVERT_CONFIG_PERMISSIONS_RESTORED', 'Dateirechte der configure.php wurden wieder auf %s gesetzt.');
defined('TEXT_MITS_CDB_CONVERT_CONFIG_UPDATED') or define('TEXT_MITS_CDB_CONVERT_CONFIG_UPDATED', 'DB_SERVER_ENGINE wurde in %s auf %s gesetzt.');
defined('TEXT_MITS_CDB_CONVERT_CONFIG_CHARSET_UPDATED') or define('TEXT_MITS_CDB_CONVERT_CONFIG_CHARSET_UPDATED', 'DB_SERVER_CHARSET wurde in %s auf %s gesetzt.');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_SUMMARY') or define('TEXT_MITS_CDB_CONVERT_CHARSET_SUMMARY', 'Zeichensatz-Konvertierung abgeschlossen: %s konvertiert, %s &uuml;bersprungen, %s fehlgeschlagen.');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_TABLE_ERROR') or define('TEXT_MITS_CDB_CONVERT_CHARSET_TABLE_ERROR', 'Tabelle %s konnte nicht auf %s / %s konvertiert werden: %s');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_TABLE_SUCCESS') or define('TEXT_MITS_CDB_CONVERT_CHARSET_TABLE_SUCCESS', 'Tabelle %s wurde auf %s / %s konvertiert.');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_TABLE_SKIPPED') or define('TEXT_MITS_CDB_CONVERT_CHARSET_TABLE_SKIPPED', 'Tabelle %s verwendet bereits %s.');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_DATABASE_ERROR') or define('TEXT_MITS_CDB_CONVERT_CHARSET_DATABASE_ERROR', 'Der Datenbank-Standard konnte nicht auf %s / %s gesetzt werden: %s');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_DATABASE_SUCCESS') or define('TEXT_MITS_CDB_CONVERT_CHARSET_DATABASE_SUCCESS', 'Der Datenbank-Standard wurde auf %s / %s gesetzt.');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_ERROR_NO_ACTION') or define('TEXT_MITS_CDB_CONVERT_CHARSET_ERROR_NO_ACTION', 'Es wurden keine Tabellen ausgew&auml;hlt und keine Charset-Anpassung aktiviert.');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_ERROR_CONFIRM') or define('TEXT_MITS_CDB_CONVERT_CHARSET_ERROR_CONFIRM', 'Die Best&auml;tigung f&uuml;r die Zeichensatz-Konvertierung fehlt.');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_START') or define('TEXT_MITS_CDB_CONVERT_CHARSET_START', 'Zeichensatz-Konvertierung starten');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_CONFIRM_CHECKBOX') or define('TEXT_MITS_CDB_CONVERT_CHARSET_CONFIRM_CHECKBOX', 'Ich habe das Encoding-Risiko gepr&uuml;ft und m&ouml;chte die Zeichensatz-Konvertierung starten.');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_TABLES_INFO') or define('TEXT_MITS_CDB_CONVERT_CHARSET_TABLES_INFO', 'W&auml;hlen Sie die Tabellen aus, die auf den Ziel-Zeichensatz und die Ziel-Collation konvertiert werden sollen.');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_NO_TABLES') or define('TEXT_MITS_CDB_CONVERT_CHARSET_NO_TABLES', 'Es wurden keine Tabellen mit Collation gefunden.');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_UPDATE_CONFIG') or define('TEXT_MITS_CDB_CONVERT_CHARSET_UPDATE_CONFIG', 'DB_SERVER_CHARSET in der aktiven configure.php auf den Ziel-Zeichensatz setzen.');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_UPDATE_DATABASE') or define('TEXT_MITS_CDB_CONVERT_CHARSET_UPDATE_DATABASE', 'Datenbank-Standard auf Ziel-Zeichensatz und Ziel-Collation setzen.');
defined('TEXT_MITS_CDB_CONVERT_CONFIG_CURRENT_CHARSET') or define('TEXT_MITS_CDB_CONVERT_CONFIG_CURRENT_CHARSET', 'Aktueller DB_SERVER_CHARSET');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_DATABASE_CURRENT') or define('TEXT_MITS_CDB_CONVERT_CHARSET_DATABASE_CURRENT', 'Aktueller Datenbank-Standard');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_TARGET_COLLATION') or define('TEXT_MITS_CDB_CONVERT_CHARSET_TARGET_COLLATION', 'Ziel-Collation');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_TARGET_CHARSET') or define('TEXT_MITS_CDB_CONVERT_CHARSET_TARGET_CHARSET', 'Ziel-Zeichensatz');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_CONFIRM_JS') or define('TEXT_MITS_CDB_CONVERT_CHARSET_CONFIRM_JS', 'Zeichensatz-Konvertierung wirklich starten?\\n\\nBitte nur fortfahren, wenn ein aktuelles Backup vorhanden ist und der Ziel-Zeichensatz korrekt gew&auml;hlt wurde.');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_WARNING') or define('TEXT_MITS_CDB_CONVERT_CHARSET_WARNING', 'Diese Funktion f&uuml;hrt ein MySQL CONVERT TO CHARACTER SET auf den gew&auml;hlten Tabellen aus. Das ist keine Reparatur bereits falsch codierter Inhalte. Bitte nur verwenden, wenn der tats&auml;chliche Datenbestand und das Ziel-Encoding bekannt sind.');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_WARNING_TITLE') or define('TEXT_MITS_CDB_CONVERT_CHARSET_WARNING_TITLE', 'Vorsicht bei Encoding-Konvertierungen');
defined('TEXT_MITS_CDB_CONVERT_CHARSET_TITLE') or define('TEXT_MITS_CDB_CONVERT_CHARSET_TITLE', 'Zeichensatz / Collation konvertieren');
